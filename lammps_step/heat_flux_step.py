...
import lammps_step  # noqa: E999


class HeatFluxStep(object):
    ...
    comments. The felds are as follows:
        ...
        my_description["description"] : tuple
            A description of the Heat Flux step. It must be
    ...
    my_description = {
        "description": "A LAMMPS step for calculating the heat flux",
        "group": "Calculations",
        "name": "Heat Flux",
    }
    ...
    def create_node(self, flowchart=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return lammps_step.HeatFlux(flowchart=flowchart, **kwargs)
    ...
    def create_tk_node(self, canvas=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return lammps_step.TkHeatFlux(canvas=canvas, **kwargs)
    ...
    def description(self):
        ...
        """
        return HeatFluxStep.my_description

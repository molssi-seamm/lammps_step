...
class VelocitiesParameters(seamm.Parameters):
    ...
    parameters = {
        "method": {
            ...
            "help_text": ("The method to use to adjuust the velocities "
        ...
        "remove_momentum": {
            "default": ("remove any translational and, for molecular systems, "
            ...
            "help_text": ("Ensure that there is no overall linear "
    ...
    def __init__(self, defaults={}, data=None):
        ...
        super().__init__(
            defaults={**VelocitiesParameters.parameters, **defaults},
            data=data
        )

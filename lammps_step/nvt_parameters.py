...
class NVT_Parameters(lammps_step.NVE_Parameters):
    ...
    parameters = {
        "thermostat": {
            ...
            "help_text": ("The thermostat used to control the "
                          "temperature.")
        },
        "T0": {
            "value": 298.15,
            ...
            "help_text": ("The temperature, or initial temperature for "
                          "simulated annealing.")
        },
        "T1": {
            "value": 298.15,
        ...
        "Tloop": {
            ...
            "help_text": ("The number of sub-iterations for the "
                          "thermostat.")
        },
        "drag": {
            "value": 0.0,
            ...
            "format_string": ".1f",
            "description": "Drag:",
            "help_text": ("The amount of drag to apply on the thermostat "
        ...
        "frequency": {
            ...
            "help_text": ("The frequency (in time units) for the thermostat "
                          "to operate.")
        },
        "window": {
            "value": 20.0,
            ...
            "help_text": ("The temperature window to use when rescaling."
        ...
        "fraction": {
            ...
            "help_text": ("The fraction of the temperature difference "
                          "to correct by sclaing the velocities.")
        },
    }
    ...
    def __init__(self, data=parameters):
        ...
        logger.debug('NVT_Parameters.__init__')

        super().__init__()

        logger.debug("Initializing NVT_Parameters object:")

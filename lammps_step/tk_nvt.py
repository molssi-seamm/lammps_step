...
class TkNVT(lammps_step.TkNVE):
    ...
    def create_dialog(self):
        ...
        t_frame = self['temperature_frame'] = ttk.LabelFrame(
            ...
            text='Temperature', labelanchor='n', padding=10)
    ...
    def reset_temperature_frame(self, widget=None):
        ...
        # Main controls
        self['T0'].grid(row=row, column=0, columnspan=2,
                        sticky=tk.W)
        row += 1

        self['T1'].grid(row=row, column=0, columnspan=2,
                        sticky=tk.W)
        row += 1

        self['thermostat'].grid(row=row, column=0, columnspan=2,
                                sticky=tk.W)
        row += 1
        ...
        if thermostat == 'Nose-Hoover':
            ...
            raise RuntimeError("Don't recognize thermostat " +
                               "'{}'".format(thermostat))
    ...
    def reset_dialog(self, widget=None):
        ...
        self['temperature_frame'].grid(row=row, column=0,

...
class NVE_Parameters(lammps_step.EnergyParameters):
    ...
    trajectories = {
        ...
        "trajectory": {
            ...
            "enumeration": ("never", "by number of samples", "by time interval"),
            "format_string": "",
            "description": "Sample the trajectory:",
        ...
        "trajectory velocities": {
            ...
            "enumeration": ("yes", "no"),
            "format_string": "",
            "description": "Include velocities:",
        ...
        "trajectory save": {
            ...
            "enumeration": ("yes", "no"),
            "format_string": "",
            "description": "Save the trajectory in a system:",
        ...
        "make current": {
            ...
            "enumeration": ("yes", "no"),
            "format_string": "",
            "description": "Make it the current system:",
        ...
        "trajectory export": {
            ...
            "enumeration": ("yes", "no"),
            "format_string": "",
            "description": "Export the trajectory:",
        ...
        "trajectory extxyz skip frames": {
            ...
            "enumeration": tuple(),
            "format_string": "",
            "description": "Skip first n frames:",
